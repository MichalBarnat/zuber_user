...
class UpdateUserPartiallyCommandToUserConverterTest {

    @Mock
    private MappingContext<UpdateUserPartiallyCommand, User> mappingContext;
    ...
    @Test
    void shouldConvertUpdateUserPartiallyCommandToUser() {
        //Given
        ...
        UpdateUserPartiallyCommandToUserConverter converter = new UpdateUserPartiallyCommandToUserConverter();
